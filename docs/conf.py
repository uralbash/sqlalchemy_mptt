...
latex_documents = [
  ('index', 'sqlalchemy_mptt.tex', u'sqlalchemy\\_mptt Documentation',
   u'Author', 'manual'),
]
...
man_pages = [
    ('index', 'sqlalchemy_mptt', u'sqlalchemy_mptt Documentation',
     [u'Author'], 1)
]
...
texinfo_documents = [
  ('index', 'sqlalchemy_mptt', u'sqlalchemy_mptt Documentation',
   u'Author', 'sqlalchemy_mptt', 'One line description of project.',
   'Miscellaneous'),
]
